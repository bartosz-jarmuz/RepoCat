...
function collapseAllToggle(sender) {
    if ($(sender).hasClass('open')) {
        ...
        $('[data-toggle="collapse"]').find('.toggler-icon').removeClass('icon-arrow-up').addClass('icon-arrow-down');
    } else {
        $(sender).addClass('open')
        $('div.collapse').addClass('show');
        $(sender).text('Collapse all')
        $('[data-toggle="collapse"]').find('.toggler-icon').removeClass('icon-arrow-down').addClass('icon-arrow-up');
    }
}
