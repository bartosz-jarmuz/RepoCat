...
namespace RepoCat.Transmission
{
    public class DotNetProjectInfoBuilder : ProjectInfoBuilderBase
    {
        ...
        public DotNetProjectInfoBuilder(ILogger logger, IProjectEnrichersFunnel projectEnrichers, TransmitterArguments args) : base(logger, projectEnrichers)
        {
            this.logger = logger;
            this.args = args;
        }
        ...
        private ProjectInfo GetInfoWithoutManifest(string projectUri, Project project)
        {
            ...
            else
            {
                ...
                projectInfoReadFromCsproj.Autogenerated = true;
                this.ProjectEnrichers.EnrichProject(projectUri, projectInfoReadFromCsproj, null);
        ...
        private ProjectInfo GetInfoWithManifest(string projectUri, ProjectItem manifestInclude, Project project)
        {
            ...
            this.ProjectEnrichers.EnrichManifestXml(projectUri, manifest, manifestInclude.ResolvedIncludePath);
            ...
            this.ProjectEnrichers.EnrichProject(projectUri, projectInfoFromManifest, manifestInclude.ResolvedIncludePath);
