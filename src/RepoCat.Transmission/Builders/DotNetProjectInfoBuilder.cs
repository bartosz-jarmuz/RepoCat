    ...
    public class DotNetProjectInfoBuilder : ProjectInfoBuilderBase
    {
        ...
        protected  override ProjectInfo GetInfo(string projectUri)
        {
            ...
            try
            {
                ...
                {
                    projectInfo = this.GetInfoWithManifest(projectUri, manifestInclude, project);
                }
                else
                {
                    projectInfo = this.GetInfoWithoutManifest(projectUri, project);
                }

                if (projectInfo != null)
                {
                    this.ProjectInfoEnrichers.EnrichProject(projectUri, projectInfo, manifestInclude?.ResolvedIncludePath, project);
                }
                return projectInfo;
            }
            catch (Exception ex)
